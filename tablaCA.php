...
INNER JOIN estado AS E ON C.Estado_idEstado=E.idEstado
...
<head>
    ...
    <link rel="stylesheet" href="css/tablaCA.css">
		...
		<table class="table" style="font-size:12px; margin-top:-1%;">
			<thead>
				<tr class="active" style="width:1200px">
                    ...
                    <th style="width:173px" scope="col">Dirección</th>
                    <th style="width:120px" scope="col">Estado</th>
					<th style="width:142px" scope="col">Municipio</th>
                    <th style="width:143px" scope="col">Telefono</th>
                    <th style="width:190px" scope="col">Email</th>
                    <th style="width:275px" scope="col">CURP</th>
					<th style="width:170px" scope="col">Tipo</th>
                    <th style="width:215px" scope="col">Fecha captura</th>
				</tr>
			</thead>
			<tbody id="miTabla">
                <?php
                ...
                <tr class="active" style="width:1500px">
                    ...
                    <td style="width:170px"><?php echo $fila['tipo'] ?></td>
                    <td style="width:180px"><?php echo $fila['fechaCaptura'] ?></td>
                </tr>
                <?php
                }
                ?>
