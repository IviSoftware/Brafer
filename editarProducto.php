...
$querys->execute();
$idP=$_GET['idP'];
$result=$conexion->prepare("SELECT productos.idProducto, productos.nombreProducto, productos.codigoBarras, productos.descripcion, productos.precio,  categorias.idCategoria, categorias.categoria, material.idMaterial, material.material FROM productos, categorias, material WHERE productos.idProducto=?");
$result->execute([$idP]);
